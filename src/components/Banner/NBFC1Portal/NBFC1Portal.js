...
import Dashboard from "./NBFC1Dashboard/Dashboard";
  ...
  if (tableData) {
    return (
      <>
        ...
        <div className="nbfc1__menu">
          <Tabs
            className="nbfc1__sidebar"
            value={tabIndex}
